...
const TPRAF_CONTENT = {
  ...
  dsp: {
    ...
    legend: [
      ...
      ["c2", "Problem Framing and Context"],
    ...
    headings: [
      ...
      { id: "dsp-c2-heading", label: "Problem Framing and Context", pos: { left: 18.96, top: 27.62, width: 13.27, height: 3.81 }, variant: "c2", text: "This process involves setting objectives and scope/boundary by clearly identifying what needs to be adapted and why. Defining the geographic scope (e.g., specific rail corridor, coastal zone, urban catchment), temporal horizons (such as 2050, 2080, or 2100), and the assets or services required. As well as capturing external factors (stakeholder needs, policy environment, and socio-economic conditions) and constraints (budget, technical feasibility, environmental restrictions, and political considerations).", isPlaceholder: false, handbookUrl: "#" },
    ...
    arrows: [
      ...
      { from: { x: 25.58, y: 40.09 }, to: { x: 25.58, y: 43.53 } },   // Systems Interdependencies -> Problem Definition
...
const TPRAF_DSP_IMP = {
  dsp: {
    ...
    text: "The DSP comprises seven modules (asset registry, asset condition, risk assessment, sustainability, risk mitigation, system interdependencies, and resilience) that underpin the six key stages and form an integrated process. Each module is a set of interconnected tools, models, or methods with specific objectives, inputs, and outputs, with clearly defined information flows across the DSP. These modules could also be standalone approaches to guide users on specific methods or approaches to expand their existing workflows or analysis/appraisal knowledge."
  },
  imp: {
    title: "Integrated Modelling Platform (IMP)",
    text: "The IMP combines models and datasets to simulate climate-related disruptions to transport infrastructure and users and explores adaptation options to increase resilience and reduce the risk. It provides a dynamic understanding of how climate hazards – such as floods and heatwaves – and the effects of infrastructure deterioration might disrupt transport systems, helping to measure impacts and inform adaptation strategies.\n\nBuilt on open-source models and datasets, the IMP is transferable across UK regions. It integrates high resolution climate projections (UKCP18), hazard modelling (e.g. flooding), agent-based transport simulations, land-use and urban development models, and impact assessment approaches. It supports risk quantification and adaptation planning, enabling interventions and investments to be prioritised."
  }
};
