...
const TPRAF_CONTENT = {
  ...
  dsp: {
    ...
    boxes: [
      ...
      { id: "dsp-economic-impact", label: "Economic Impact", pos: { left: 53.4, top: 55.93, width: 11.37, height: 3.93 }, text: "Content coming soon — awaiting text from DARe.", isPlaceholder: true, handbookUrl: "#", variant: "navy" },
      ...
      { id: "dsp-solution-bundling", label: "Solution Bundling", pos: { left: 69.05, top: 46.66, width: 10.74, height: 7.68 }, text: "This process looks at combining and sequencing multiple interventions/pathways to utilise and bundle resources if possible.", isPlaceholder: false, handbookUrl: "#", variant: "navy" },
      { id: "dsp-resource-feasibility", label: "Resource and Feasibility", pos: { left: 69.05, top: 57.34, width: 10.74, height: 7.68 }, text: "Content coming soon — awaiting text from DARe.", isPlaceholder: true, handbookUrl: "#", variant: "navy" },
